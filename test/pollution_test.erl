...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
get_maximum_gradient_station_test() ->
  M = pollution:add_station("Stacja 2", {2,2}, pollution:add_station("Stacja 1", {1,1}, pollution:create_monitor())),
  M1 = pollution:add_value("Stacja 1",{{2023,3,27},{11,16,10}},"PM10", 10, M),
  M2 = pollution:add_value("Stacja 2",{{2023,3,27},{11,16,10}},"PM10", 10, M1),
  M3 = pollution:add_value("Stacja 1",{{2023,3,27},{11,16,11}},"PM10", 20, M2),
  M4 = pollution:add_value("Stacja 2",{{2023,3,27},{11,16,11}},"PM10", 15, M3),
  ?assertMatch("Stacja 1", pollution:get_maximum_gradient_station("PM10",M4)),
  M5 = pollution:add_value("Stacja 2",{{2023,3,27},{11,16,12}},"PM10", 10000, M4),
  M6 = pollution:add_value("Stacja 2",{{2023,3,27},{11,16,13}},"PM10", 9999, M5),
  ?assertMatch("Stacja 2", pollution:get_maximum_gradient_station("PM10",M6)).
